...
- [TypeScript 타입 종류](#typescript-타입-종류)
  ...
  - [Object Types](#object-types)
    ...
    - [Extending Types(타입 확장)](#extending-typestype-확장)
      ...
      - [Type Alias와 Intersection Types](#type-alias와-intersection-types)
    - [Arrays](#arrays)
  - [Functions](#functions)
    - [void](#void)
...
타입을 확장할 때 기존 속성의 타입을 구체적으로 재정의할 수 있다.
...
#### Type Alias와 Intersection Types

Interface 확장 대신 교집합 타입을 사용할 수도 있다.
